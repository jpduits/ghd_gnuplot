...
# legenda
set cblabel "Changeability" font ",8"  # Zet de lettergrootte voor de legenda
set cbtics font ",8"

set title data_title font "Helvetica,16"

# Plot the data
# Gebruik kolom 5 voor de kleurwaarden
#data_file=system("echo $DATA_FILE")
plot data_file using 1:2::5 with points palette pointtype 7 notitle, \
     '' using 1:2:9 with labels offset char 0,-0.5 font ",7" textcolor rgb "grey" notitle

# ander dubbele labels
unset label 
