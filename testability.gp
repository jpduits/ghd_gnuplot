...
# legenda
set cblabel "Testability" font ",8"  # Zet de lettergrootte voor de legenda
set cbtics font ",8"

set title data_title font "Helvetica,16"

# Plot the data
# Gebruik kolom 7 voor de kleurwaarden
#data_file=system("echo $DATA_FILE")
plot data_file using 1:2::6 with points palette pointtype 7 notitle, \
